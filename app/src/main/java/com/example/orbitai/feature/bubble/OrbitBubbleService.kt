...
class OrbitBubbleService : Service() {
    ...
    private fun handleTranscript(transcript: String) {
        ...
        if (BubbleSettingsStore(this).bubbleResultsInOverlay) {
    ...
    private fun showResultOverlay(
        ...
        val responseHeightPx = dpToPx(BubbleSettingsStore(this).bubbleResponseHeightDp.toFloat())
    ...
    private fun buildResultCardView(
        ...
        val store = BubbleSettingsStore(this)
    ...
    private fun dismissBubble() {
        hideResultOverlay()
        BubbleSettingsStore(this).isFloatingBubbleEnabled = false
        stopSelf()
    }
